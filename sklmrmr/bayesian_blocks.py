...
Note: this file has been temporarily borrowed from the astroML project
(http://www.astroml.org/) because that project has not yet been ported
to Python 3.
...
class Events(FitnessFunc):
    ...
    def fitness(self, N_k, T_k):
        ...
        if np.any(N_k == 0) or np.any(T_k == 0):
